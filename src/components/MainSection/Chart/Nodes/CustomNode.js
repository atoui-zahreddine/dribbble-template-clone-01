    ...
    () => (
      <>
        <img
          ...
          alt="profile-img"
        />
        <div style={{borderRadius:"50%",width:"60px",height:"60px",fontSize:"18px",display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"white",padding:"10px",position:"absolute",top:"30%",left:"-65%"}}>
            50 %
        </div>
      </>
    ),
