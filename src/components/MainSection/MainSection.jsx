...
import {AiOutlineFolderAdd, AiOutlineSearch, AiOutlineUnorderedList} from "react-icons/ai";
        ...
        <div className="App-main-section">
            <header className="main-section-header">
                <span className="header-layout-btn">
                    <span className={`rounded-btn ${menuLayout === 0 ? "active" : ""}`}
                          onClick={() => setMenuLayout(0)}>
                        <CgMenuGridR size='1.5rem'/>
                    </span>
                    <span className={`rounded-btn ${menuLayout === 1 ? "active" : ""}`}
                          onClick={() => setMenuLayout(1)}>
